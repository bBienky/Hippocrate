...
class Hypothese(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:11pt;\">Veuillez editer les Hypothèses résultant des symptômes du patient</span></p></body></html>"))
        item = self.tableWidget.horizontalHeaderItem(0)
        item.setText(_translate("Form", "Hypothèse"))
